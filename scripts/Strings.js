...
module.exports = {
	loginPrompt:  
                            ...
                            "Use the HELP command for a list of commands and their usages.                                        \n" +
				            "=====================================================================================================\n" +
				            "                                                                                                     \n",
	...
	notFound: 			    "Not found",
	via:                    " -> {{name}}",
	incorrectArgs:          "Thats not how you use the \'{{command}}\' command! Type 'help' for more.",
	help:                   "{{ command }}",
    alreadyThere:           "You're standing in that room!"
};
